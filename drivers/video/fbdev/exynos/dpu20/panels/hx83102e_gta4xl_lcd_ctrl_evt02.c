...
#include "hx83102e_gta4xl_param_evt02.h"
#include "dd.h"
...
static int hx83102e_read_init_info_evt02(struct lcd_info *lcd)
{
...
#if defined(CONFIG_SEC_FACTORY)
static int hx83102e_read_id_evt02(struct lcd_info *lcd)
{
	struct panel_private *priv = &lcd->dsim->priv;
	int i, ret = 0;
...
static int hx83102e_displayon_late_evt02(struct lcd_info *lcd)
{
	int ret = 0;
...
static int hx83102e_exit_evt02(struct lcd_info *lcd)
{
	int ret = 0;
...
static int hx83102e_init_evt02(struct lcd_info *lcd)
{
	int ret = 0;
				...
				unsigned long event, void *data)
{
	...
	if (fb_blank == FB_BLANK_UNBLANK)
		hx83102e_displayon_late_evt02(lcd);

	return NOTIFY_DONE;
}

static int hx83102e_probe_evt02(struct lcd_info *lcd)
{
	int ret = 0;
	...
	ret = hx83102e_read_init_info_evt02(lcd);
	if (ret < 0)
...
struct dsim_lcd_driver hx83102e_mipi_lcd_driver_evt02 = {
	.name		= "hx83102e_evt02",
	.probe		= dsim_panel_probe,
	.displayon	= dsim_panel_displayon,
	.suspend	= dsim_panel_suspend,
};
__XX_ADD_LCD_DRIVER(hx83102e_mipi_lcd_driver_evt02);
